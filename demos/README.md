...
Live demonstration apps for the "Automate Your Workday with AI" session.
...
GitHub Spark app using a single comprehensive prompt. Transforms vague "boss requests" into actionable automation plans with ready-to-run scripts (PowerShell, KQL, Graph API).
...
3. Access the published Spark app links
4. Try the sample requests